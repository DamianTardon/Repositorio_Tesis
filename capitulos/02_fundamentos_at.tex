...
En este capítulo se expone la caracterización y evaluación del ensayo de impulso atmosférico tipo rayo, fundamentado en la norma IEC 60060-1 \cite{iec60060_1}. Primeramente se encontrarán las definiciones formales de la onda estándar de tensión \qty[parse-numbers=false]{1,2/50}{\micro\second}, abarcando las configuraciones de onda plena y onda cortada, junto con las tolerancias normativas admitidas en los parámetros característicos de la onda. A continuación, se describen los principios operativos del ensayo de impulso, y la configuración del sistema de medición necesario. Finalmente, se abordan los algoritmos matemáticos descriptos en la norma IEC 60060-1 \cite{iec60060_1}, para analizar las señales.
