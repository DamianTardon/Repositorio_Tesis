...
\begin{equation}
    u_d(t) = U \cdot \left( e^{-\frac{t-t_d}{\tau_1}} - e^{-\frac{t-t_d}{\tau_2}} \right)
    \label{Eq:DobleExponencial}
\end{equation}
Donde:
\begin{singlespace}
    \setlength{\parskip}{0pt}
    \noindent $u_d(t)$: función de tensión.\\
    $t$: tiempo.\\
...
\begin{singlespace}
    \setlength{\parskip}{0pt}
    \noindent $w_{i+1}$: vector de parámetros actualizado.\\
...
\begin{singlespace}
    \setlength{\parskip}{0pt}
    \noindent $\alpha$: tamaño de paso de avance de la iteración.
\end{singlespace}
