...
\section{Arquitectura de software adoptada}
...
\begin{itemize}
    \item \textbf{Vista:} Maneja exclusivamente la representación visual del software y la interacción del usuario. Se mantiene completamente independiente de la lógica de adquisición y procesamiento, emitiendo señales que son capturadas por el presentador para desencadenar las acciones correspondientes.
    \item \textbf{Modelo:} Está compuesto por tres módulos:
    \begin{enumerate}
        \item \textbf{Controlador de hardware}: Traduce las acciones requeridas a comandos que el osciloscopio pueda interpretar.
...
\begin{enumerate}
    \item \textbf{Abstracción de hardware}: Encapsula todas las operaciones de control, configuración de canales y adquisición de datos de la memoria del osciloscopio, mediante comandos SCPI, usando el protocolo de comunicación PyVISA.
