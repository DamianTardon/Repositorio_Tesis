...
El controlador inicializa el administrador de recursos, y ejecuta un escaneo automático para buscar algún dispositivo conectado, que tenga un descriptor de recurso lógico VISA, como los ejemlos de las tablas \ref{tab:descriptor_asrl} y \ref{tab:descriptor_usb}.
