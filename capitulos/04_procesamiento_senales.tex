...
Este capítulo detalla los fundamentos teóricos del procesamiento digital de señales (DSP).
...
A diferencia de los FIR, estos filtros utilizan retroalimentación (feedback). Es decir, la salida actual se calcula utilizando las entradas actuales y pasadas, y además las salidas anteriores del propio filtro.
...
La técnica de filtrado de fase cero o bidireccional, elimina el desfase temporal antes mencionado. Esta técnica consiste en procesar los datos en forma directa e inversa en el dominio del tiempo: 
\begin{enumerate}
...
Dado que la información pasa dos veces por el algoritmo del filtrado, se duplica la atenuación de las frecuencias filtradas y se duplica de tiempo de cálculo en comparación con un filtrado unidireccional. No obstante, este incremento en el procesamiento es aceptable frente al significativo beneficio de preservar la integridad temporal y morfológica de los datos.
