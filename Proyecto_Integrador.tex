...
\documentclass[11pt, final]{report} % Clase de documento para un informe.
\usepackage{fancyhdr}
...
\raggedbottom
\setlist{nosep} % Configuración global: elimina todo el padding vertical elástico
...
\pagenumbering{roman}
%\input{capitulos/00a_portada.tex}
%\input{capitulos/00b_acta_tribunal.tex}
%\input{capitulos/00c_acta_director.tex}
%\input{capitulos/00d_dedicatoria.tex}
%\input{capitulos/00e_agradecimientos.tex}
%\input{capitulos/00f_resumen.tex}
...
\cleardoublepage
%\input{capitulos/00g_simbolos_convenciones.tex}
...
\input{capitulos/06_descripcion_modelo.tex}
\input{capitulos/07_calibracion.tex}


% ====================================================================================
\part{RESULTADOS Y CONCLUSIONES}
\input{capitulos/08_resultados.tex}
\input{capitulos/09_conclusiones.tex}
